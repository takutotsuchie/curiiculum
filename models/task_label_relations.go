...
var TaskLabelRelationWhere = struct {
	...
	ID:      whereHelperint{field: "\"task_label_relations\".\"id\""},
...
var (
	...
	taskLabelRelationColumnsWithoutDefault = []string{"task_id", "label_id"}
	taskLabelRelationColumnsWithDefault    = []string{"id"}
...
func FindTaskLabelRelation(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*TaskLabelRelation, error) {
...
func TaskLabelRelationExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
